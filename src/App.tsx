...
export function App() {
  ...
  return (
    <div className="relative z-[2] flex min-h-dvh w-full flex-col items-stretch text-[#f4f4f8] max-lg:pt-[env(safe-area-inset-top)]">
      <div className="mx-auto flex w-full max-w-[min(100%,72rem)] flex-1 flex-col items-center px-[var(--space-section-x)] py-[var(--space-section-y)] max-md:items-stretch">
        <header className="relative z-10 mb-[var(--space-hero-gap)] w-full max-w-2xl text-center lg:mb-[var(--space-10)]">
          <p className="mb-[var(--space-3)] text-[var(--text-eyebrow)] font-semibold uppercase tracking-[0.14em] text-white/55 [font-family:var(--font-sans)]">
            Interactive catalog
          </p>
        ...
        >
          <span className="block sm:inline">Drag to spin</span>
